...
"""
    节点间数据隔离:OuputSchema中定义了哪些参数就输出哪些字段
"""
...
class MyState(BaseModel):
    query:str
    new_query:str = ""
    reg_search_result:str | None = None
...
# 初始化 LangGraph
graph = StateGraph(state_schema=MyState, input_schema=InputSchema, output_schema=OuputSchema)
...
response= compiled_graph.invoke({
    "query":"如何使用LangGraph",
    "new_query":"如何使用LangGraph",
})
print(response) # OuputSchema中定义了哪些参数就输出哪些字段
